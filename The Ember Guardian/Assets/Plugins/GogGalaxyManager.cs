...
public class GogGalaxyManager : MonoBehaviour
{
    ...
    private void OnDestroy()
    {
        ...
        /// When using Unity Editor PlayMode use this method to preserve needed static objects between playModeStateChanged
        if (Application.isEditor)
        {
            ShutdownParams shutdownParams = new ShutdownParams(true);
