	...
	public class RedistCopy {
		...
		public static void OnPostprocessBuild(BuildTarget target, string pathToBuiltProject) {
			...
			if (target == BuildTarget.StandaloneWindows64) {
				...
				CopyFile ("GalaxyCSharp.dll", Path.Combine (outputLibLocation, "GalaxyCSharp.dll"));
			}
				...
				CopyFile ("MacOS/libGalaxy.dylib", Path.Combine (outputLibLocation, "libGalaxy.dylib"));
				CopyFile ("MacOS/libGalaxyCSharpGlue.dylib", Path.Combine (outputLibLocation, "libGalaxyCSharpGlue.dylib"));
				CopyFile ("GalaxyCSharp.dll", Path.Combine (outputLibLocation, "GalaxyCSharp.dll"));
			}
			#endif
		}
