...
namespace Galaxy {
	...
	public class RedistInstall {
		...
		static RedistInstall() {
					...
					CopyFile ("MacOS/libGalaxy.dylib", "libGalaxy.dylib", true);
					CopyFile ("MacOS/libGalaxyCSharpGlue.dylib", "libGalaxyCSharpGlue.dylib", true);
			#endif
			CopyFile ("GalaxyCSharp.dll", "GalaxyCSharp.dll", true);
